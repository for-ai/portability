...
import setup_helpers.cmake

import setup_helpers.env  # noqa: F401 unused but resolves circular import
                ...
                with contextlib.ExitStack() as stack:
                    ...
                    stack.enter_context(
                        unittest.mock.patch.object(
                            setup_helpers.cmake, "USE_NINJA", use_ninja
                        )
                    )
                    stack.enter_context(
                        unittest.mock.patch.object(
                            setup_helpers.cmake, "IS_WINDOWS", is_windows
                        )
                    )

                    cmake = setup_helpers.cmake.CMake()
