...
f, ax = plt.subplots(figsize=(45, 70))


ax.set(
    yscale="log", ylim=(10e-8, 100), xlabel="Device", ylabel="Time taken (milliseconds)"
)
...
plt.ylabel("Time (milliseconds)", labelpad=15)
# plt.xticks(rotation=90, pad=20)
ax.tick_params(axis="x", pad=20, labelsize=180)
ax.tick_params(axis="y", pad=20, labelsize=180)


plt.savefig("plot_images/global_plot/" + framework + "_times.png", bbox_inches="tight")
plt.show()
# break
# Show the plot
